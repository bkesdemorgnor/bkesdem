...
const egresoRegKardex =  async (venta,newVenta) =>{
    //mongoose.set('useFindAndModify', false);
    //console.log('addKardex',area,tipoKardex,sucursal,productoId,prodReq);
    //console.log('egresoRegKardex',indice,sucursal,fecha,venta.PRODUCTO);
    if (venta && newVenta ) {
        ...
        if (carta) {
            ...
            const Result = await egresoRecetaDetKardex(carta,venta,newVenta)
        ...
        console.log('Error: Venta Falta parametro:',venta,newVenta);
...
const egresoRecetaDetKardex =  async (carta,venta,newVenta) =>{
    if(carta.isActivo){
        if(carta.recetaId !==""){
            // TIENE RECETA
            console.log('egresoRecetaDetKardex Tiene Receta carta.recetaId !=="":',carta.nombre,venta.producto,newVenta.producto);
...
const updateStockProm =  async (recetaCantidad,oldKardex,cantidad,fecha,newKardexDet) =>{
    if(recetaCantidad && oldKardex && cantidad && fecha && newKardexDet){
        ...
        console.log('Error egresoRegKardex updateStockProm parametro vacio oldKardex',oldKardex, "newKardexDet",newKardexDet);
...
const sleep =  async (milliseconds) =>{
 ...
 module.exports = {egresoRegKardex:egresoRegKardex}