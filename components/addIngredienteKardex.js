...
const addIngredienteKardex =  async (ingredienteId,prodReq) =>{
    //mongoose.set('useFindAndModify', false);
    console.log('addIngredienteKardex',ingredienteId,prodReq.nombre);
    if (ingredienteId) {
        ...
        if(sucursales){
          ...
          sucursales.forEach( async (s,i) => {
            ...
            if(s.isActive){
              ...
              await addAllAreaKardex(s,ingredienteId,prodReq)
            }else{
...
const addAllAreaKardex = async (sucursal, porcionId, prodReq) => {
 ...
 module.exports = {addIngredienteKardex:addIngredienteKardex}